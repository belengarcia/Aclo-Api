                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="wrapper" bgcolor="#eeeeee">
                  <tr>
                    <td align="center" bgcolor="#eeeeee">
                      <a href="" target="_blank" style="font-size: 12px; line-height: 14px; font-weight: 500; font-family: 'Roboto Mono', monospace; color: #212121; text-decoration: underline;padding: 16px; border: 1px solid #eeeeee; display: inline-block;">FUCK OFF! </a>
                    </td>
                  </tr>
                </table>
              </td>
                                  ...
                                  <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                    ...
                                    <tr>
                                      <td align="center" class="hund ripplelink" width="600">
                                        <img align="center" width="600" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 600px!important" class="hund" src=${data.destiny.img}>
                                      </td>
                                    </tr>
                                    <!-- END HEADER IMAGE -->
                                    <!-- START BODY COPY -->
                                    ...
                                    <tr>
                                      ...
                                      Dear ${to}  
                                      <br>
                                      It looks like ${from.name} is a little bit upset with you and thinks it is better for you to fuck off. This could sound awful, but no worries. We have selected an amazing place for you to do it: <strong>${data.destiny.name}</strong>!!
                                        <br><br>
                                        Enjoy! :)
                                      </td>
                                    </tr>
                                              ...
                                              <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td align="left" style="border-radius: 3px;" bgcolor="#17bef7">
                                                    <a class="button raised" href="http://localhost:4200/destinies/${data.id}" target="_blank" style="font-size: 14px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 10px 25px; border: 1px solid #17bef7; display: inline-block;">I'M INTERESTED</a>
                                                  </td>
                                                </tr>
                                              </table>
                                            </td>
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              <tr>
                                <td class="td-padding" align="center" style="font-family: 'Roboto Mono', monospace; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 0px; padding-left: 0px!important; padding-right: 0px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 0px 0px 0px 0px;">
                                  &copy; 2018 Made with a lot of hate (and a little bit of love <3)
                                </td>
                              </tr>
                              <tr>
                                <td align="center" bgcolor="#eeeeee">
                                  <a href="*|UNSUB|*" target="_blank" style="font-size: 12px; line-height: 14px; font-weight: 500; font-family: 'Roboto Mono', monospace; color: #212121; text-decoration: underline;padding: 16px; border: 1px solid #eeeeee; display: inline-block;">Unsubscribe</a>
                                </td>
                              </tr>
                            </table>
                          </td>
